...
class IterM:
    ...
    def run(self):
        ...
        for t in range(1,self.nrp-2):
            ...
            sigma_z2 = self.Gaa + self.Gbb*epstT**2.0 + self.Gmm*epstT1**2.0 + self.sigma_e2
            ...
            # update \bar{z}_{t}
            self.zbar[t] = self.abar[t] + self.bbar[t]*epstT + self.mbar[t] * epstT1;
            ...
            mat1 = -1.0 / self.omega_z_2 * np.array([[tmp], [tmp * epstT], [tmp * epstT1]])
